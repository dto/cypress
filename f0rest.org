...
** TODO make new animations work
** TODO autoscale frames so that scale1.0 =>> 600x600 ends up *monk-size* x *monk-size* , centered


** TODO walk with bow 
** TODO hold shift to ready bow
** TODO let go of shift to fire arrow
