...
*** TODO use sorted vector and custom code to make z-depth work
...
** TODO equip normal bow during prologue
** TODO Check dx7 patches for cool analogue sfx. 

** TODO disable cursor in game window?
** TODO USEing can require an argument to apply verb to; this pauses and changes cursor
** TODO contextual modeline verb buttons
** TODO working locks and keys
** TODO doors controlled by nearby locks
** TODO stairwells
...
** TODO don't halo objects when shell not open
** TODO [#A] fix diagonal scrolling jitter
** TODO [#A] clean up main guy walk animation
...
** TODO fix pick coordinates when window scaled
