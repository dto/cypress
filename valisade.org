...
** TODO [#A] dialogue bark bubbles
** TODO [#A] Fix mac window resizing bugs
** TODO [#A] possibly swap right-click and left-click i.e. movement/look
** TODO [#A] fix checkbox issues where not showing in middle
** TODO [#A] increase pond size
** TODO [#A] implement snow/rain/darkness
** TODO [#A] fix geoffrey-in-wrong-world bug
** TODO [#A] Consider fully turn-based combat
** TODO [#A] fix UUID drag errors
** TODO [#A] restrict visitable map squares
** TODO [#A] disallow re-visiting same square
** TODO [#A] Disallow flee/exit when enemies near
** TODO [#A] Skeleton archers
** TODO [#B] allow canceling travel
** TODO [#B] increase map grid density and procgen it
** TODO [#B] Control Q and Command q should quit game
** TODO [#B] Lucius help AI?
