...
** TODO [#A] fix new bag-to-bag item move crash
** TODO [#A] fix slots-filled error when items would stack ok
** TODO [#A] Cryptghast
** TODO [#A] Cemetery
...
** TODO Make travel not use reagents if returning to same square
** TODO [#A] add secrets in less-used parts of map


** TODO print message when eat snowdrop
