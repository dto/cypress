...
** TODO [#A] Fix crystal arrow crash
** TODO [#A] Fix possible crash on making arrows without enough stuff 
** TODO [#A] Fix erroneously dropping objects behind scroll gump when intending to put them inside
