...
*** TODO Import spell/action icons
*** TODO Write function that checks that given required reagents/quantities/conditions are present
**** TODO Implement player status conditions via these checks
...
** TODO RESUME after issuing order
** TODO Merge items whe adding to inventory
*** TODO Show quantity in container


** TODO Implement tactical combat
*** TODO indicate PAUSED status in lower-right corner
*** TODO implement PAUSE and RESUME functions
*** TODO toggle pause with middle-click
*** TODO toggle pause with SPACEBAR
*** TODO toggle pause with TAB
** TODO Require raise-time for bow
** TODO Require rest-time for bow
*** TODO modify combat speed with spell/item
** TODO Animate bow according to status
** TODO Add jitter to aim when cold/exhausted
** TODO Right click self to toggle combat

** TODO Remove Lucius for now
