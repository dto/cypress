...
** TODO Review todo list

** TODO [#A] Don't allow tent to be put in containers other than Geoffrey
** TODO [#B] Fix spellcasting/activating objects after dead
** TODO [#B] Fix lack of paused message
...
** TODO Music edit
*** TODO add verb / compression to ruins
*** TODO eq standing-by-the-river to remove hum
