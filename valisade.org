...
** DONE [#A] Fix can't pathfind to near trees, give them smaller and rounder hitbox
   CLOSED: [2014-07-28 Mon 09:33]
...
** TODO [#A] Auto-stop Geoffrey near wolf
** TODO [#A] stop wolf when too close; bite and run BLOOD!

** TODO [#B] Integrate hintbook into game
** TODO [#A] add more specific music events at add-objective points
** TODO [#A] scale up font mode
** TODO [#A] have Maxwell tell you about waystone before other convo

** TODO [#B] add symbol or other decoration to waystone?
** TODO [#B] restructure dialog paths to keep more topics available
** TODO [#B] possibly use vertical dialogue paths

* Feedback
** TODO rewrite final wizard convo
** TODO black wizard bark sounds are pitched up proto-ildronian
** TODO make sure player doesn't miss savepoint dialog

** TODO fix sextant to remind player about savepoints
** TODO explain sextant in game
** TODO add system to make sure whole soundtrack is played
** TODO add short battle cues and victory
** TODO look for unused art

* Story 

** TODO [#B] explain why triangle key is on corpse in outpost via letter

*** TODO wax scroll movie with pitched-down chorused skull voice

** TODO [#B] 2nd shayol dossier
