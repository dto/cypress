...
** TODO test 2x0ng and cypress for play
** TODO Playtest thoroughly and verify helpscroll before demo

** TODO better distribution of herbs
** TODO [#A] make hungry/cold messages into Geoffrey-aligned bark bubbles

** TODO [#A] add lore and grab-boxes to basements

** TODO Draft lore for various sources
*** TODO [#B] stone monk AI with Lore?
** TODO [#B] lighting should "boil"
...
** TODO [#A] disallow travel in the dark.
** TODO [#A] implement crypts

** TODO [#A] implement open caves with filled regions as perspex walls and flat dirt or stone background, dark halo
