...
** DONE make conversation gump use the standard scroll graphic, maybe slightly smaller
   CLOSED: [2014-02-24 Mon 14:52]
** TODO rework conversatin topic system
** TODO only display buttons on last page of response
** TODO use :after methods with EQ :topic specializers to do non-text actions

** TODO Lucius NPC

Bark "Ho, stranger."

Greetings, brother. Well met.

My name is Lucius Pentaquin. I don't recall ever seeing robes like
yours! You must be a traveler?
