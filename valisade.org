** TODO [#A] Better flower clusters and wood around dead trees
** TODO [#A] make pretty magic potions more common
** TODO [#A] Add grave hag corpses with bone dust
** TODO [#A] Fix pathfinding / placement bugs when exiting basements
...
** TODO [#A] Small basements in ruins
** TODO [#A] Reduce size of gray stairwells
