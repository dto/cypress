...
** DONE add info about stone of remembrance, bubble should indicate what to do 
   CLOSED: [2014-08-19 Tue 23:49]
** TODO [#A] Fix tent inelegance. allow double click tent and/or easy return
** TODO reset dialog box when dead

** TODO [#B] make sure credits are readable in-game

** TODO suppress console window on win32

** TODO have lucius bark if player takes too long to leave meadow after lucius joins
** TODO add spellbook/travel info to lucius after-join dialogue
** DONE auto open adventurers guide
   CLOSED: [2014-08-12 Tue 20:56]
** TODO don't allow showing multiple X
** DONE fix game freezing for a while when geoffrey's destination causes pathfind to exhaust map
   CLOSED: [2014-08-12 Tue 20:56]

** DONE adventurers guide should say something about talking
   CLOSED: [2014-08-12 Tue 20:41]
	
** DONE Fix error on quit on Win
   CLOSED: [2014-08-12 Tue 20:41]
    debugger invoked on a CL-OPENGL-BINDINGS:OPENGL-ERROR in thread
    #<THREAD "main thread" RUNNING {25BAB621}>:
      OpenGL signalled (1282 . INVALID-OPERATION) from DELETE-TEXTURES.
    ...
    0]
Backtrace for: #<SB-THREAD:THREAD "main thread" RUNNING {25BAB621}>
0: (CL-OPENGL-BINDINGS:CHECK-ERROR #<unavailable argument>)
1: (CL-OPENGL:DELETE-TEXTURES (14))
2: (XELF:CLEAR-TEXT-IMAGE-CACHE :DELETE-TEXTURES T)
3: (XELF:SHUT-DOWN)
4: ((LAMBDA NIL :IN "Z:/home/dto/xelf/build-sbcl.lisp"))
5: ((FLET #:WITHOUT-INTERRUPTS-BODY-42 :IN SAVE-LISP-AND-DIE))
6: ((LABELS SB-IMPL::RESTART-LISP :IN SAVE-LISP-AND-DIE))
7: ("foreign function: #x429740")
8: ("foreign function: #x41670C")
 
** DONE Fix no indication of click during long movie loading time
   CLOSED: [2014-08-12 Tue 20:41]

** TODO Auto-pause when an enemy approaches for first time
** TODO allow Control-Q dialog to quit game
** DONE add opening movie
   CLOSED: [2014-08-11 Mon 18:10]
** DONE destroy all gumps after exiting any scene
   CLOSED: [2014-08-11 Mon 19:21]

** TODO [#A] implement quest journal
*** TODO journal book should open gump of simple list of strings, display in reverse order
*** TODO add objectives and notes (wraith etc) to it
*** TODO rework Objectives to 40-column notes
** TODO [#A] Add a sidequest or two
*** TODO [#A] look for unused art for sidequests
*** TODO [#A] add ruined town sidequest and secret stuff north of cemetery
**** TODO protection spell
** TODO [#A] Accessibility: Large print mode 
** TODO [#A] Accessibility: Adjust colors/shapes of herbs/potions for color vision impairment
...
** TODO [#A] Close scrolls with X in corner, more intuitive
** TODO [#A] Fix wrong displayed arrow stock amount on modeline when arrows in sub-bag
   :PROPERTIES:
   :Effort:   0:15
   :END: 

** TODO [#B] save game to ~/.cypress.xelf on linux and mac
...
** TODO [#C] save to ~/Library/Application Support/Cypress/cypress.sav on mac
...
** TODO [#C] when firing at enemy and don't have LOS, try pathfinding until LOS
...
** TODO [#C] Add Clockwork Valisade Knight
   ...
   :Effort:   3:00
   :END:
** DONE [#C] Paint some nicer pine trees
   CLOSED: [2014-08-09 Sat 08:29]
   :PROPERTIES:
   :Effort:   1:00
   :END:
...
** DONE [#A] Fix can't pathfind to near trees,
   CLOSED: [2014-08-09 Sat 08:27]
   :PROPERTIES:
   :ARCHIVE_TIME: 2014-08-09 Sat 08:27
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_CATEGORY: valisade
   :ARCHIVE_TODO: DONE
   :END:
*** TODO give them smaller and rounder hitbox
*** DONE or when can't pathfind to spot try: walking toward point in str8 line until stop or: shorten path
    CLOSED: [2014-08-09 Sat 08:27]

** DONE [#A] Implement bleeding and blood tracks in the snow
   CLOSED: [2014-08-09 Sat 08:28]
   :PROPERTIES:
   :Effort:   1:00
   :ARCHIVE_TIME: 2014-08-09 Sat 08:30
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_CATEGORY: valisade
   :ARCHIVE_TODO: DONE
   :END:

** DONE [#A] fix laggy cam
   CLOSED: [2014-08-09 Sat 08:28]
   :PROPERTIES:
   :ARCHIVE_TIME: 2014-08-09 Sat 08:30
   :ARCHIVE_FILE: ~/cypress/valisade.org
...
** DONE [#A] Should allow to click gear as well as plate to unlock puzzle
   CLOSED: [2014-08-09 Sat 08:40]
   :PROPERTIES:
   :Effort:   0:15
   :ARCHIVE_TIME: 2014-08-09 Sat 08:40
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_CATEGORY: valisade
   :ARCHIVE_TODO: DONE
   :END:

** DONE [#A] add subtle Now Loading screen graphic
   CLOSED: [2014-08-09 Sat 16:17]
   :PROPERTIES:
   :ARCHIVE_TIME: 2014-08-09 Sat 16:17
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_CATEGORY: valisade
   :ARCHIVE_TODO: DONE
   :END:
