...
** TODO when geoffrey not near/talking, Lucius should wander around and collect flowers
*** TODO randomly choose a flower on the map
*** TODO walk to it 
*** TODO take 1 or 2 flowers from any cluster
*** TODO repeat

** TODO [#A] draw an example quest map with notes
** TODO [#A] increase map grid density and procgen it
** TODO [#A] Create list of quest components 
** TODO [#A] map coordinate system with 27N, 7E or  ... 12S, 142E
** TODO [#A] valisade is in the northeast
...
** TODO [#B] make hungry/cold messages into Geoffrey-aligned bark bubbles
