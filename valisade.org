...
** TODO fix pathfinding timeout for unreachable areas (expand first bounding box)
** TODO refresh inventory after drop on container
** TODO Lengthen double click time
** TODO Don't allow multiple browsers on one object
** TODO make screen not scroll during combat?
** TODO switch to tactical combat
** TODO Don't allow to drop gumps into containers
