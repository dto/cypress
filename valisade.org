...
** TODO Change scene class so that it only generates terrain on first visit
...
* TODO hidden forest cemetery with screech owl
...
** TODO move character-following AI into base class
...
* Nothbehem
** TODO move nothbehem down 1 row
** TODO add arturo conversations and items
** TODO make arturo's house into a container
*** TODO add woolen leggings, woolen shirt, 
*** TODO add spellbooks: craft silver arrows, cure meat
*** TODO add copper-lock
