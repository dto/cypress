* Tasks
** TODO Fix crash when trying to move remains
** TODO Fix misaligned text bubbles when identifying objects in gumps and window is not at 0,0
** TODO Allow to activate objects in gumps
