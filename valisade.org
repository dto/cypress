...
* Beta
** TODO [#A] Fix pathfing bypassing copper gate and getting stuck
   :PROPERTIES:
   :Effort:   2:00
   :END:
...
** TODO [#A] auto stop walking and pause when enemy in view.
   :PROPERTIES:
   :Effort:   0:30
   :END:
...
** TODO [#A] 2nd cylinder
   ...
   :END:
** TODO [#A] ENDGAME
*** TODO [#A] Paint and program extreme cold furs for visiting amalia's cabin
    :PROPERTIES:
    :Effort:   0:30
    :END:
