...
** TODO fix potions and herbs to not trigger color blindness issues
** TODO remove lucius reference to Monastery
** TODO paint a library/monastery
** TODO suppress extra application window on Windows
** TODO suppress SDL-GFX error 
** TODO puddles should be obstacles and cracks should surround 
** ~/Library/Application Support/Cypress/cypress.sav
** TODO bring ashes to cairn in sidequest
** TODO consider scaling down to save resolution
** TODO   call NSSearchPathForDirectoriesInDomains to    find the application support folder
** TODO save game to  ~/Library/Application Support/App Name on mac or ~/Library/Preferences/cypress 
** TODO save game to ~/.cypress.xelf on linux
** TODO Explain the souls wandering, dreamlike state
** TODO Improve convo system, implement embedded keywords, easier Actions
** TODO expand arturo's beginning conversations. 
** TODO cartomancy puzzle future
** TODO correct Arturo's description of waystone/sextant
** TODO more camping tooltips
