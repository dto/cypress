...
** TODO make new scrolls always open on top
...
** TODO make container drop zone larger so that it's easier to grab stuff 
** TODO disallow container to be dropped into self :)
