...
** TODO [#A] re-enable pause, auto stop walking and pause when enemy in view.
** TODO [#A] enlarge enemy attack-click hitbox- use single right click to target enemies, show hover indicator when properly targeted
...
** TODO [#A] Magic arrow, (nightshade) single strong attack with crystal arrow graphics
   ...
   :Effort:   1:00
   :END:
** TODO [#A] implement southeastern ruin with Wiz0rds
** TODO [#A] wraith archer 
...
** TODO [#A] Sextant points way to waystones
...
*** TODO [#A] cylindrophone
    ...
    :Effort:   0:30
    :END:
*** TODO [#A] 2nd stone monk in cave w 4 doors
    :PROPERTIES:
    :Effort:   2:00
    :END:
*** TODO [#A] Frozen river with skeleton archers
    ...
    :Effort:   2:00
    :END:
*** TODO [#A] amalia's cabin
    :PROPERTIES:
    :Effort:   1:00
    :END:
*** TODO [#A] valisade ruins w/monks sound
    :PROPERTIES:
    :Effort:   0:30
    :END:
