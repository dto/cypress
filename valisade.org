...
** TODO Choose what else goes in tonight's 0.5 release
*** TODO [#A] Spellcast animation
*** TODO [#B] Implement low HP warning

** TODO Increase combat tactics
*** TODO Require raise-time for bow, during which you cannot move. 
*** TODO Require rest-time for bow, during which you cannot fire again
...
** TODO Abstractify the sounds and ifnd new ones     
