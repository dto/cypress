...
** TODO organize, prioritize, and Verbify todo list
** TODO review unused art and objects.lisp

** TODO Require light spell in dark areas
** TODO Magic outdoor item boxes with coverstone.png coverstone2.png item-box.png
** TODO Better flower clusters and wood around dead trees
** TODO also, in ancient caves: lock/key system--- plate with lock, you must use corresponding key
*** TODO circle/triangle/warrior

** TODO define criteria for 0.9 release

** TODO allow push/pop of topic set
** TODO books with lore
** TODO silver books with spells/Special lore
** TODO implement Hold Creature
...
** TODO Add caves with item box / stone monk
...
** TODO make story cubes out of the image gallery and create UserStories 
** TODO xiotank tones/symbols for copper doorway puzzles
...
*** TODO Skull seance
*** TODO Books
** TODO add lore and grab-boxes to basements

** TODO [#A] Paint the village of Nothbess. 
