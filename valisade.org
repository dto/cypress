...
**** TODO Write silver journal entries, it's raining ash
...
*** TODO [#B] something about a buried monk, find his ossuary and dig up the key 
*** TODO [#B] require Translation to read/open graves in that cemetery
** TODO wax cylinder, map, and Shayol dossier should be found in north ruins
...
*** TODO get flute, protection spell and info at valisade
** TODO [#C] check for more unused art
** TODO [#C] incorporate illegible map

** TODO remove puddles from frozen meadow/forest
