...
** TODO [#A] implement darkness
** TODO [#A] implement open caves with filled regions as objects and flat dirt or stone background, dark halo
** TODO [#A] home icon becomes cave icon

** TODO [#B] increase map grid density and procgen it with Valisade in Northeast

** TODO [#A] restrict visitable map squares in order to begin testing Act I (exception: holding shift)

** TODO [#A] day/night cycle; survive each day; end it by camping 
...
** DONE when geoffrey not near/talking, Lucius should wander around and collect flowers
   CLOSED: [2014-02-26 Wed 08:22]
   :PROPERTIES:
   :ARCHIVE_TIME: 2014-02-26 Wed 10:58
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_OLPATH: Tasks
   :ARCHIVE_CATEGORY: valisade
   :ARCHIVE_TODO: DONE
   :END:
*** DONE randomly choose a flower on the map
    CLOSED: [2014-02-26 Wed 08:22]
*** DONE walk to it 
    CLOSED: [2014-02-26 Wed 08:22]
*** DONE take 1 or 2 flowers from any cluster
    CLOSED: [2014-02-26 Wed 08:22]
*** DONE repeat
    CLOSED: [2014-02-26 Wed 08:22]

** DONE [#A] draw an example quest map with notes
   CLOSED: [2014-02-26 Wed 10:58]
   :PROPERTIES:
   :ARCHIVE_TIME: 2014-02-26 Wed 10:58
   :ARCHIVE_FILE: ~/cypress/valisade.org
   :ARCHIVE_OLPATH: Tasks
