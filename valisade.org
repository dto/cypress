...
* Part I
** TODO Make magic potions more common
*** TODO Switch to new red=health/blue=mana/green=hunger potion graphics. 
** TODO fix can't camp here again
   :PROPERTIES:
   :Effort:   0:15
   :END:
** TODO fix clicking through dialog choice buttons
   :PROPERTIES:
   :Effort:   0:15
   :END:
...
** TODO require reaching middle 1/3 of level in order to travel
   ...
   :Effort:   0:30
   :END: 
** TODO Finish screech owl flute northern cave quest (gears)
   :PROPERTIES:
   :Effort:   0:30
   :END:
*** TODO finish owl dialogue
*** TODO finish quine letter 2
*** TODO add cave with gears and potions
...
*** TODO [#A] Spirit of Warrior (marks good hunting zones)
*** TODO [#A] Abandoned well / ruin
